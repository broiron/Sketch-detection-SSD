...
dataset_root = '/home/broiron/broiron/line_dataset_vol4_pascal/'
cfg = voc
...
criterion = MultiBoxLoss(5, 0.5, True, 4, True, 3, 0.5, False, True)
...
for iteration in range(0, iter_size):
    ...
    if iteration != 0 and iteration % 500 == 0:
        ...
        torch.save(ssd_net.state_dict(), 'weights/ssd300_line3_' +
                       repr(iteration) + '.pth')
